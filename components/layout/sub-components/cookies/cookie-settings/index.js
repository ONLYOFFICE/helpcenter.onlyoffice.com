        ...
        <Checkbox
          label={
            <StyledCheckText>
              ...
              <Text color="#666666" fontSize="14px">{t("TechnicalDescription")}</Text>
            </StyledCheckText>
          }
        ...
        <Checkbox
          label={
            <StyledCheckText>
              ...
              <Text color="#666666" fontSize="14px">{t("AnalyticalDescription")}</Text>
            </StyledCheckText>
          }
        ...
        <Checkbox
          label={
            <StyledCheckText>
              ...
              <Text color="#666666" fontSize="14px">{t("MarketingDescription")}</Text>
            </StyledCheckText>
          }
